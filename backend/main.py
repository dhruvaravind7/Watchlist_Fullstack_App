...
async def create_user(user: User):
    ...
    id = users.add_user(user.username, hash_password, user.email or "")
...
@app.post("/add/movie")
async def add_movie(movie: WatchlistMovie):
    watchlist.add_to_watchlist(movie.watcher_id, movie.tmdb_id, movie.title, movie.poster_path or "")
...
@app.post("/add/rating")
async def add_movie_rating(movie: RatingMovie):
    watchlist.add_rating(movie.watcher_id, movie.tmdb_id, movie.rating)

@app.post("/add/watched")
async def add_movie_watched(movie: RatingMovie):
